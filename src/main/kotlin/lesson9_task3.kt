fun main() {
    val listOfIgredients = listOf(COUNTS_OF_EGGS, COUNTS_OF_MILK, COUNTS_OF_BUTTER)
    var numberOfServing: Int

    println("Укажите количество порций для омлета:")
    numberOfServing = readln().toInt()

    println("На $numberOfServing кол-во порций вам понадобится: " +
            "Яиц - ${listOfIgredients[0] * numberOfServing} шт., молока - ${listOfIgredients[1] * numberOfServing} мл., " +
            "сливочного масла - ${listOfIgredients[2] * numberOfServing} гр.")
}
